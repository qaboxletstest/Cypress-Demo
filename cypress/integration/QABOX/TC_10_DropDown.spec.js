describe("XPath", () => {
  ...
  it.skip("Multi Select - Select html element - Chosen jQuery Plugin", () => {
    cy.visit("http://127.0.0.1:5500/Help%20Folder/differentDropDownTypes.html");
    // cy.get('#mSelect').select(['United States', 'Albania', 'Angola'], { force: true }).invoke('val').should('deep.equal', ['United States', 'Albania', 'Angola'])
  ...
  it.skip("automationpractice Auto Completion", () => {
